...
<!-- Bootstrap core CSS     -->
    ...
    <body>
        ...
        <div class="sidebar" data-color="blue" data-image="{{ url('/') }}/img/sidebar-1.jpg">
            ...
            <div class="logo">
                <img class="img-responsive" width="150" height="150" src="{{ url('/') }}/wp-content/themes/cryptapp/images/lago.png" alt="Genesys">
                <a href="/" >
        ...
        <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright">
                        &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">Genesys</a>
                    </p>
                </div>
            </footer>
        </div>
