                ...
                <div class="grid grid--container">
                    <div class="authorization authorization--login">
                        <a class="site-logo" href="/">
                            <img class="img-responsive"  src="{{ url('/') }}/wp-content/themes/cryptapp/images/lago.png" alt="Genesys">
                        </a>

                        <form class="authorization__form" accept-charset="UTF-8" role="form" method="post" action="{{ route('auth.password.reset.attempt', $code) }}">
                            <h3 class="__title">Create New Password</h3>

                            <div class="input-wrp  {{ ($errors->has('password')) ? 'has-error' : '' }}">
                                <input  class="textfield" placeholder="Password" name="password" type="password" value="" />
                                {!! ($errors->has('password') ? $errors->first('password', '<p class="text-danger">:message</p>') : '') !!}
                            </div>

                            <div class="input-wrp  {{ ($errors->has('password_confirmation')) ? 'has-error' : '' }}">
                                <input class="textfield" placeholder="Confirm Password" name="password_confirmation" type="password" value="" />
